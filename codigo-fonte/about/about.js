...
const textoSecundario = document.querySelector("#text-secundario");

textoSecundario.textContent = `Ajudamos o maior número de Instituições sem fins lucrativos a receberem mais
